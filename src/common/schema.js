...
const SCHEMAS = [
   ...
   */
  {
    ...
    fields: {
      ...
      gen1_guarded_effective_evidence_allowed: { type: 'boolean', required: false, desc: 'Key 3 成立' },
      gen1_guarded_effective_health_allowed: { type: 'boolean', required: false, desc: '运行时 Health 门成立' },
      gen1_guarded_effective_active: { type: 'boolean', required: false, desc: 'effective_guarded 合成结果' },
      gen1_guarded_effective_invocations: { type: 'number', required: false, desc: '本轮真实采纳次数' },
      ...
      gen1_guarded_evidence_seal_reason_code: { type: 'string', required: false, desc: 'Evidence Seal 未通过原因码' },
