...
function mergeShadowOutputs(v38Result, v3Result, params, trendStageEnabled) {
  ...
  // Gen-1 Advisory 仍必须保留 V3.6.1 基线，供人工复核与一键回退。
  shadow.v361_baseline_target = v3Result.v361_baseline_target != null
    ? v3Result.v361_baseline_target : v3Target;
  shadow.v361_baseline_action = v3Result.v361_baseline_action || v3Result.final_action || null;
  shadow.v361_baseline_stage = v3Result.v361_baseline_stage
    || v3Result.trend_stage_primary || v3Result.trend_stage || null;
  shadow.gen1_advisory_target = v3Result.gen1_advisory_target != null
    ? v3Result.gen1_advisory_target : null;
  shadow.gen1_advisory_action = v3Result.gen1_advisory_action || null;
  shadow.gen1_advisory_effective = v3Result.ml_advisory_effective === true;
