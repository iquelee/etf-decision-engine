 ...
 *
 * 说明（共享知识 B3-4）：
 * - 本文件只存「默认值」，运行时阈值一律读 param_config 集合，代码零硬编码；
...
const SEC_FINANCIAL_TICKERS = [
  // —— 存储周期（513310 直接相关）——
  { symbol: 'usMU', name: '美光科技', code: 'MU', cik: '0000723125', related: ['513310', '159582'], factor: '存储周期' },
  { symbol: 'usSNDK', name: '闪迪', code: 'SNDK', cik: '0002023554', related: ['513310'], factor: 'NAND存储' },
  ...
  { symbol: 'usAMD', name: 'AMD', code: 'AMD', cik: '0000002488', related: ['513310', '159582'], factor: 'AI芯片' },
  { symbol: 'usQCOM', name: '高通', code: 'QCOM', cik: '0000804328', related: ['159582', '513310'], factor: '移动芯片' },
  { symbol: 'usAAPL', name: '苹果', code: 'AAPL', cik: '0000320193', related: ['513310'], factor: '消费电子/AI' },
  { symbol: 'usTSLA', name: '特斯拉', code: 'TSLA', cik: '0001318605', related: ['513310'], factor: 'AI超算/汽车' },
  // —— 光模块/光通信（515880 直接相关）——
  { symbol: 'usAAOI', name: '应用光电', code: 'AAOI', cik: '0001158114', related: ['515880'], factor: '光模块' },
  { symbol: 'usGLW', name: '康宁', code: 'GLW', cik: '0000024741', related: ['515880'], factor: '光纤光缆' },
  { symbol: 'usMRVL', name: '迈威尔', code: 'MRVL', cik: '0001835632', related: ['515880', '513310'], factor: '数据中心DSP' },
  ...
  // —— 创新药（159570 直接相关）——
  { symbol: 'usLLY', name: '礼来', code: 'LLY', cik: '0000059478', related: ['159570'], factor: '创新药/GLP-1' }
];
...
const FINANCIAL_CONDUCTION_MAP = {
  usMU: { '513310': ['capex', 'hbm_demand', 'ai_server_demand'], '159582': ['wafer_capex', 'leading_order', 'advanced_process'] },
  usSNDK: { '513310': ['hbm_demand'] },
  usAMAT: { '159582': ['wafer_capex', 'leading_order', 'advanced_process'] },
  usASML: { '159582': ['advanced_process', 'wafer_capex', 'leading_order'] },
  usTSM: { '159582': ['wafer_capex', 'advanced_process', 'leading_order'], '513310': ['hbm_demand'] },
  usARM: { '159582': ['advanced_process', 'leading_order'], '513310': ['ai_server_demand'] },
  usNVDA: { '515880': ['ai_cluster', 'optical_800g', 'cpo_progress'], '513310': ['ai_server_demand', 'hbm_demand'], '159582': ['advanced_process'] },
  usAMD: { '513310': ['ai_server_demand'], '159582': ['advanced_process'] },
  usQCOM: { '159582': ['leading_order'], '513310': ['ai_server_demand'] },
  usAAPL: { '513310': ['ai_server_demand'] },
  usTSLA: { '513310': ['ai_server_demand'] },
  usAAOI: { '515880': ['optical_800g', 'cpo_progress', 'asp'] },
  usGLW: { '515880': ['optical_800g', 'asp'] },
  usMRVL: { '515880': ['optical_800g', 'cpo_progress'], '513310': ['ai_server_demand'] },
  usMSFT: { '515880': ['cloud_capex', 'ai_cluster'], '513310': ['ai_server_demand'] },
  usGOOGL: { '515880': ['cloud_capex', 'ai_cluster'], '513310': ['ai_server_demand'] },
  usAMZN: { '515880': ['cloud_capex'], '513310': ['ai_server_demand'] },
  usMETA: { '515880': ['cloud_capex', 'ai_cluster'], '513310': ['ai_server_demand'] },
  usORCL: { '515880': ['cloud_capex'], '513310': ['ai_server_demand'] },
  usLLY: { '159570': ['leading_revenue', 'core_sales', 'bd_licensing', 'overseas', 'clinical'] }
};
...
const NEWS_SECTOR_KEYWORDS = {
  ...
  '518880': ['黄金', '美联储', '央行购金', '金价', '降息'],
  '159570': ['创新药', '恒瑞医药', '百济神州', '临床', '获批', 'BD交易']
};

/** 新闻方向初筛关键词（利好/利空），后续可升级 LLM 精确提取 */
const NEWS_DIRECTION_KEYWORDS = {
  positive: ['涨价', '上调', '增长', '超预期', '获批', '中标', '扩产', '回购', '增持', '降息', '突破', '新高', '供不应求', '订单增加'],
...
module.exports = {
  ...
  COOLDOWN_DAYS, BUILD_FIRST_LOT_PCT, ADD_BREAKOUT_MAX_PCT, ADD_THRESHOLD_PCT, OVER_ALLOC_REDUCE_PCT,
