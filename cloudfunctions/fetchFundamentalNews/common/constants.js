...
const TRADE_LOG_UPDATE_FIELDS = [
  'trade_date', 'action', 'shares', 'price', 'amount',
...
/** V3.9 E3：W4 零仓首仓试探豁免 sector（与 decision.js allowsW4AiNetworkFirstLot 同步） */
const E3_FIRST_LOT_SECTORS = ['ai_network'];
...
module.exports = {
  ...
  TECH_SECTORS, SEMI_SECTORS, E3_FIRST_LOT_SECTORS,
