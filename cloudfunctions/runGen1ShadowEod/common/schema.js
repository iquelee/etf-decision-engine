...
const SCHEMAS = [
  ...
  },
  {
    ...
    fields: {
      ...
      rule_permission_reason_code: { type: 'string', required: false, desc: '许可预检原因码' },
      rule_permission_reason: { type: 'string', required: false, desc: '许可预检中文说明' },
      rule_permission_source: { type: 'string', required: false, desc: 'EOD_STAGE_PRECHECK/SAFETY_CORE' },
      ...
      signal_status_reason: { type: 'string', required: false, desc: '信号降级/不可用原因（面向历史审计）' },
      signal_run_id: { type: 'string', required: false, desc: 'EOD 推理任务批次 ID' },
